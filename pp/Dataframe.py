...
class Dataframe:
    ...
    def getDataframe_ACSIncome(self, size):
        dataName= "ACSIncome"
        df_original = pd.read_csv(f'/Users/Shatha/Downloads/pp/inputData/ACSIncome_state_number1.csv')
    ...
    def getDataframe_Healthcare(self, size):
        dataName= "Healthcare"
        df_original = pd.read_csv('/home/dbgroup/shatha/pp/inputData/healthcare_800_numerical.csv')
