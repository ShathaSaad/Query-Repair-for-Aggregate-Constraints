...
class filtered_fully:
    ...
    def check_predicates(self, sorted_possible_refinements, statistical_tree, expression, datasize, dataName):
        counter = 0
        agg_counter = 0
        ...
        for refinement in sorted_possible_refinements:
            ...
            for root_key in root_clusters:
                ...
                filtered_clusters, counter = self.filter_clusters_Hash(root_key, cluster_map, condition1, condition1_operator, condition2, 
                condition2_operator, filtered_clusters, counter, parent_child_map)
            ...
            check_counter += 1
            satisfied, agg_counter = evaluate_constraint.evaluate_constraint(filtered_df, expression, condition1, condition2, agg_counter, similarity, "full")
            ...
            #filename = f'filtered_fully_income_{condition1}_children_{condition2}.csv'
        ...
        satisfied_conditions_df.to_csv("satisfied_conditions_Fully.csv", index=False)
    ...
    def filter_clusters_Hash(self, current_key, cluster_map, condition1, condition1_operator, condition2, condition2_operator, filtered_clusters, 
